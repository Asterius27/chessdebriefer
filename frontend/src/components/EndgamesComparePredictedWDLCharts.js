...
function EndgamesComparePredictedWDLCharts({ name, url, onLoad, section }) {
                ...
                <div style={{margin: "auto", width: "80%", display: "table"}}>
                    <div style={{display: "table-row"}}>
                        ...
                        <div style={doughnutStyle}>
                            <DoughnutChart chartData={generalChartData} text={name + " predicted" + section + " wdl endgame stats"} displayLabels={flag} />
                        </div> : <div></div>
                        }
                        ...
                        <div style={doughnutStyle}>
                            <DoughnutChart chartData={compareGeneralChartData} text={"Other players predicted" + section + " wdl endgame stats"} displayLabels={flag} />
                        </div> : <div></div>
                        }
                    </div>
                    <div style={{display: "table-row"}}>
                        ...
                        <div style={doughnutStyle}>
                            <DoughnutChart chartData={whiteChartData} text={name + " white predicted" + section + " wdl endgame stats"} displayLabels={flag} />
                        </div> : <div></div>
                        }
                        ...
                        <div style={doughnutStyle}>
                            <DoughnutChart chartData={compareWhiteChartData} text={"Other player's white predicted" + section + " wdl endgame stats"} displayLabels={flag} />
                        </div> : <div></div>
                        }
                    </div>
                    <div style={{display: "table-row"}}>
                        ...
                        <div style={doughnutStyle}>
                            <DoughnutChart chartData={blackChartData} text={name + " black predicted" + section + " wdl endgame stats"} displayLabels={flag} />
                        </div> : <div></div>
                        }
                        ...
                        <div style={doughnutStyle}>
                            <DoughnutChart chartData={compareBlackChartData} text={"Other player's black predicted" + section + " wdl endgame stats"} displayLabels={flag} />
                        </div> : <div></div>
                        }
                    </div>
                </div>
